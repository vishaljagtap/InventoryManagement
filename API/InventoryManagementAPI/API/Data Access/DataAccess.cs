  ...
  public class DataAccess : IDataAccess
  {
    ...
    public IList<Book> GetAllBooks()
    {
      ...
      using (var conn = new SqlConnection(DbConnection))
      {
        ...
        books = conn.Query<Book>(sql);

        foreach (var book in books)
        {
          sql = "select * from BookCategories where Id=" + book.CategoryId;
          book.Category = conn.QuerySingle<BookCategory>(sql);
        }
        return books.ToList();
      }
    }
    ...
    public IList<Order> GetOrdersOfUser(int userId)
    {
      ...
      using (var conn = new SqlConnection(DbConnection))
      {
        var sql = @"
                ...
                ";
        orders = conn.Query<Order>(sql, new { Id = userId });
      }
    ...
    public IList<User> GetUsers()
    {
      ...
      using (var conn = new SqlConnection(DbConnection))
      {
        ...
        var listOfOrders =
            conn.Query("select u.Id as UserId, o.BookId as BookId, o.OrderedOn as OrderDate, o.Returned as Returned from Users u LEFT JOIN Orders o ON u.Id=o.UserId;");
    ...
    public IList<BookCategory> GetAllCategories()
    {
      ...
      using (var conn = new SqlConnection(DbConnection))
      {
        categories = conn.Query<BookCategory>("select * from BookCategories;");
      }
